...
public class BookingFacade {
    ...
    public void bookNow(Booking booking) throws Exception {
        ...
        booking.addObserver(new BookingLoggerObserver());
        ...
        Taxi t = chosen.get();
        booking.setAssignedTaxiId(t.getTaxiId());
        ...
        pool.submit(() -> {
            try {
                ...
                Thread.sleep(ms); // simulation for trip duration
                ...
                log.error("Trip simulation error for booking " + booking.getBookingId() + ": " + ex.getMessage());
